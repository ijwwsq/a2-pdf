...
Markdown или docx разбирается в единый список блоков, блоки превращаются
в HTML со стилями брендбука, headless chromium печатает его в PDF, PyMuPDF
склеивает обложку с телом и штампует колонтитулы с номерами страниц.
